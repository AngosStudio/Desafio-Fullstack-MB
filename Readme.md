...
## Para subir o ambiente de BackEnd
...
## Para subir o ambiente de FrontEnd

Existem 2 maneiras para fazer isso, a versão de Produção ou de testes / desenvolvimento.

Para subir o ambiente no modo Dev, basta executar os comandos abaixo:
...
Para subir o ambiente como produção, precisa confirmar se tem instalada a lib Serve (caso não a tenha: `npm install -g serve`). Com ela instalada, execute:
...
![Telas Desafio](https://user-images.githubusercontent.com/83235141/225743749-ca86ca69-5902-4a75-bb42-d6c0fc169bf4.png)
